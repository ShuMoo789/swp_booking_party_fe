...
import premium from "../pickSpot/premium.jpg";
...
import "../../pages/pickSpot/pickSpot.scss";
  ...
  return (
    <Box className="event-details">
      ...
      <div className='container' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px' }}>
        <div style={{ height: '100%', width: '1000px', borderRadius: '10px', background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          <img src={premium} alt="Premium Room" style={{ height: '32.5%', width: '32.5%', marginTop: '5%', marginBottom: '5%', borderRadius: '10px 10px 0 0' }} />
